...
export MASTODON_CROSS_SLACK_TRIGGER=off
export MASTODON_CROSS_TWITTER_USERNAME_1=IdrissNeumann
export MASTODON_CROSS_TWITTER_OWNER_1=IdrissNeumann
export MASTODON_CROSS_TWITTER_KEYWORD_1=mirrorpt
export MASTODON_CROSS_STREAM_PRIMARY_SRC=mastodon
